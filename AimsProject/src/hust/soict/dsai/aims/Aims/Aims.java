...
public class Aims {
	...
	public static void main(String[] args) {
	 ...
	 public static void initSetup() {
		    ...
		    DigitalVideoDisc dvd1 = new DigitalVideoDisc("Finding Nemo", "Animation", "Andrew Stanton", 100, 15.95f);     
		    DigitalVideoDisc dvd2 = new DigitalVideoDisc("Interstellar", "Science Fiction", "Christopher Nolan", 169, 29.99f); 
		    DigitalVideoDisc dvd3 = new DigitalVideoDisc("Cinderella", "Animation", 12.50f);
		    store.addMedia(dvd1);
		    store.addMedia(dvd2);
		    store.addMedia(dvd3);

		    Book book = new Book("The Hound of the Baskervilles", "Mystery", 25.00f);
		    Book book1 = new Book("Becoming", "Memoir", 150.00f);
		    Book book2 = new Book("Astrophysics for People in a Hurry", "Science", 80.00f);
		    store.addMedia(book);
		    store.addMedia(book1);
		    store.addMedia(book2);

		    CompactDisc cd1 = new CompactDisc("Taylor Swift - Midnights", "Music", "Taylor Swift", 999.50f);
		    Track track1CD1 = new Track("Anti-Hero", 200);
		    Track track2CD1 = new Track("Midnight Rain", 180);
		    Track track3CD1 = new Track("Labyrinth", 250);
		    cd1.addTrack(track1CD1);
		    cd1.addTrack(track2CD1);
		    cd1.addTrack(track3CD1);

		    CompactDisc cd2 = new CompactDisc("Harry's House", "Music", "Harry Styles", 1200.75f);
		    Track track1CD2 = new Track("As It Was", 173);
		    Track track2CD2 = new Track("Music for a Sushi Restaurant", 180);
		    Track track3CD2 = new Track("Matilda", 240);
		    cd2.addTrack(track1CD2);
		    cd2.addTrack(track2CD2);
		    cd2.addTrack(track3CD2);

		    CompactDisc cd3 = new CompactDisc("Divide", "Music", "Ed Sheeran", 899.90f);
		    Track track1CD3 = new Track("Shape of You", 240);
		    Track track2CD3 = new Track("Castle on the Hill", 261);
